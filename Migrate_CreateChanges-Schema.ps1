...
$pilot_filename = "C:\Code\Base\ServiceConfig\sourceSchema.xml"
$production_filename = "C:\Code\Base\ServiceConfig\targetSchema.xml"
$changes_filename = "C:\Code\Base\ServiceConfig\schemachanges.xml"
